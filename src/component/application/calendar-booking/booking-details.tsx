...
export default function BookingDetails({
  ...
  return (
    <div className={cn("flex flex-col p-6 lg:w-[220px] lg:px-4 lg:pt-8", className)}>
      ...
      <p className="mb-2 text-lg font-semibold text-default-foreground">Demo call</p>
      ...
      <div className="mb-6 flex flex-col gap-3">
        ...
        <div className="flex items-center">
          <Icon className="flex-shrink-0 text-default-300" icon="solar:global-linear" width={16} />
          <Select
